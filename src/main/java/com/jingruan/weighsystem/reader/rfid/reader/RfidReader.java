package com.jingruan.weighsystem.reader.rfid.reader;

import com.jingruan.weighsystem.reader.rfid.transport.Transport;
...
public abstract class RfidReader  {
	...
	public abstract void HandleMessage() throws IOException;	//处理接收到的信息
	protected abstract void NotifyMessageToApp(byte[] message,int startIndex) throws IOException;
}
